...
--
-- Host: localhost:3306
-- Generation Time: Apr 17, 2023 at 08:33 PM
...
('root', '[{\"db\":\"test\",\"table\":\"users\"},{\"db\":\"test\",\"table\":\"user\"},{\"db\":\"test\",\"table\":\"login\"}]');
...
('root', '2023-04-17 15:02:39', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":0}');
...
INSERT INTO `users` (`id`, `username`, `password`, `phone`, `dob`, `gender`) VALUES
(8, 'bb', 'aa', '1234567890', '1444-03-03', 'feMale'),
(9, 'admin', '1111', '5555555555', '2002-03-23', 'Male');
